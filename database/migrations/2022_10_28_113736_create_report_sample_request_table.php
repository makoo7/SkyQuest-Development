...
class CreateReportSampleRequestTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('report_sample_request', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('report_sample_request');
    }
}
