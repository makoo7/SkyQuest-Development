        ...
        <div class="container">
            <div class="menu">
                <div class="navigation-icn">
                    ...
                    <path d="M0 0h30v1H0zm0 10h30v1H0z" fill-rule="evenodd" fill="#fff"></path>
                    </svg>
                </div>
                <div class="sq-logo">
                    <a href="{!! route('home') !!}"><img src="{!! asset('assets/frontend/images/logo.png') !!}" alt="sq-logo" width="230" height="33"></a>
                </div>
                <div class="menu-list">
            ...
            <div class="account-login">
                <div class="avtar-dropdown dropdown">
                    <a href="" class="btn name-btn" id="dropdowntopMenuButton2" data-bs-toggle="dropdown" aria-expanded="false">
                        @if(request()->root() == config('app.domain_name_english'))
                        <span class="user-name">English</span>
                        @else
                        <span class="user-name">Japanese</span>
                        @endif
                        {{-- <img src="{{ Auth::user()->image_url }}" class="user-img" alt="user-img"/> --}}
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdowntopMenuButton2">
                        <li><a class="dropdown-item" onClick='callUrl("{{ config("app.domain_name_english") }}")'>English</a></li>
                        <li><a class="dropdown-item" onClick='callUrl("{{ config("app.domain_name_japanese") }}")'>Japanese</a></li>
                    </ul>
                </div>
            </div>
            <div class="account-login">
                @if(auth('web')->check())
                <a href="{!! route('my-bookmarks') !!}"><img class="book-mark-tag" src="{!! asset('assets/frontend/images/bookmark.svg') !!}" width="16" height="22" alt="Top market research company in India"></a>
                @else
                <img class="book-mark-tag" id="viewBookmark" src="{!! asset('assets/frontend/images/bookmark.svg') !!}" width="16" height="22" alt="Top market research company in India">                
                @endif
                ...
                @endif
		<form class="header-search-form desk" name="frmsearch" id="frmsearch" method="post" action="{!! route('search-detail') !!}">
                    @csrf
                    <div class="input-group">
                        <input type="text" class="form-control search-click" id="searchtxt" name="searchtxt" placeholder="Search..." value="{!! old('searchtxt') ?? app('request')->input('searchtxt') !!}">
...
<form class="header-search-form mob black" name="frmsearchMobile" id="frmsearchMobile" method="post" action="{!! route('search-detail') !!}">
    @csrf
    <div class="input-group">
        <input type="text" class="form-control" id="searchtxtMobile" name="searchtxtMobile" placeholder="Search..." value="{!! old('searchtxtMobile') ?? app('request')->input('searchtxtMobile') !!}">
        <button class="btn" type="submit" id="searchbtnMobile" name="searchbtnMobile" aria-label="search btn"><i class="fas fa-search"></i></button>
    </div>
