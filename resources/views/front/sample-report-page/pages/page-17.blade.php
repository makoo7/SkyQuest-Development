    ...
    <div class="row">
        ...
        <div class="col-lg-7 col-md-6">
            <ul class="list square-points hypothesis-list mb-0">
                ...
                <li class="list-items data-point-list">Primary  research  is  used  both  to  validate  the  data  points   obtained  from  secondary research and to fill the data gaps after secondary research.</li>
            </ul>
