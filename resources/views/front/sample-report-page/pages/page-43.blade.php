...
<div class="text-container height-100vh initial-height">
    ...
    <div class="content-height">
        <h5 class="purple-color text-center font-weight-bold">Figure 1: <span>Report Name</span> Global Market Size in US$ Bn (2018-2030)</h5>
        <div style="height: 60vh;"><canvas id="global-market-bar-chart"></canvas></div>
