        ...
        <div class="row">
            <div class="col-lg-2 col-md-6 col-12">
                ...
                <ul class="p-0 list-unstyled">
                    ...
                    <li class="mb-4">Competition between Online and Offline Companies</li>
                    <li class="mb-4">Level of Advertising expenses</li>
                    <li class="mb-4">Powerful competitive strategies</li>
                    <li class="mb-4">Entry & exit barriers</li>
                    <li class="mb-4">Product Pricing</li>
