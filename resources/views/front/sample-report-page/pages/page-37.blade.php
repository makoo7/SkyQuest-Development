...
<div class="text-container height-100vh">
    ...
    <div class="content-height">
        <div class="row">
            <div class="col-md-6">
                <img src="{{ asset("assets/frontend/slide/37/2.png") }}" alt="image" class="img-fluid" />
            </div>
            <div class="col-md-6">
                <h5 class="purple-background text-center p-2 mb-1">KEY TAKEAWAYS</h5>
                <table class="industry-development-table takeaway-table w-100">
                    <thead>
                        <tr>
                            <th>PARAMETER</th>
                            <th>Description</th>
