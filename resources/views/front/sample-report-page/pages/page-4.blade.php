...
<div class="d-flex justify-content-end align-items-center mb-5">
    ...
    <div class="main-page-title-block text-center d-flex justify-content-center align-items-center flex-wrap">
        <div>
            <h2 class="main-page-number mt-0" style="font-size: 4rem;">REPORT NAME</h2>
            <h6 class="main-page-title">TABLE OF CONTENTS</h6>
        </div>
    </div>
</div>