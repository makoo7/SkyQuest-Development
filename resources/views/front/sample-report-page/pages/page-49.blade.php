...
<div class="d-flex justify-content-end align-items-center mb-5">
    ...
    <div class="main-page-title-block text-center">
        <h2 class="main-page-number">07</h2>
        <h6 class="main-page-title mb-0">MARKET SIZE BY GEOGRAPHY 1</h6>
        <h6 class="main-page-title">2018 - 2030</h6>
    </div>
</div>