                        ...
                        <form class id="frmsamplerequest" name="frmsamplerequest" method="post"
                            ...
                            <div class="contct-form row">
                                ...
                                <div class="form-inner col-6 mb-3">
                                    <input class="form-control" type="text" placeholder="First Name*" name="name" id="name"
                                ...
                                <div class="form-inner col-6 mb-3">
                                    <input class="form-control" type="text" placeholder="Last Name*" name="lastname" id="lastname"
                                        @if(auth('web')->check() && isset(Auth::user()->lastname))
                                    value="{{ Auth::user()->lastname }}" readonly @endif>
                                    @error('lastname')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
