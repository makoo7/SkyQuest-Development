...
<section class="forms">
    <div class="container-fluid">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg-12 addlink">
                        <a href="{!! route('admin.roles.add') !!}"  class="btn btn-primary mb-4 admin-top">Add New</a>
                    </div>
                    @endif
                    <div class="col-lg-12">
                                ...
                                <div class="mb-3">
                                    <div class="form-inline">
                                        ...
                                        <button id="buttonGo" type="submit" class="btn btn-primary"
                                            >Go!</button>
                                        <a id="btn_clear" href="{!! route('admin.roles.index') !!}" class="btn btn-outline-danger ml-2">Clear</a>                                                    
                                    </div>
                                </div>
        ...
        <div class="card">
            <div class="card-body" id="roles_list">
            </div>
        </div>
