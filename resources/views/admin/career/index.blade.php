...
<section class="forms">
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    @if(auth('admin')->user()->can('career-add'))
                    <div class="col-lg-12 addlink">
                        <a href="{!! route('admin.career.add') !!}"  class="btn btn-primary mb-4 admin-top">Add New</a>
                    </div>
                    @endif
                    <div class="col-lg-12">
                            ...
                            <div class="filter-row d-flex align-items-center">
                                <div class="mb-3">
                                    <div class="form-inline">
                                        ...
                                        <a id="btn_clear" href="{!! route('admin.career.index') !!}" class="btn btn-outline-danger ml-2">Clear</a>
                                    </div>
                                </div>
        ...
        <div class="card">
            <div class="card-body" id="career_list">
            </div>
        </div>
