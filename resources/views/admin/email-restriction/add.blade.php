...
<section class="forms">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <form id="frmAddUpdate" name="frmAddUpdate" action="{!! $email_restriction->id ? route('admin.email-restriction.update') : route('admin.email-restriction.store') !!}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12 text-center">
                                        ...
                                        <button type="button" class="btn btn-outline-danger" onclick="location.href='{!! route('admin.email-restriction.index') !!}';">Cancel</button>
                                    </div>
                                </div>
                            </div>
                        </div>
