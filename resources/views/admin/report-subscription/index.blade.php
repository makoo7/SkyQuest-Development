...
<section class="forms">
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    @if(auth('admin')->user()->can('report-subscription-export'))
                    <div class="col-lg-12 addlink">
                        <a href="{!! route('admin.report-subscription.export') !!}"  class="btn btn-primary mb-4 admin-top">Export Data</a>
                    </div>
                    @endif
                    <div class="col-lg-12">
                            ...
                            <div class="filter-row d-flex align-items-center">
                                <div class="mb-3">
                                    <div class="form-inline">
                                        ...
                                        <a id="btn_clear" href="{!! route('admin.report-subscription.index') !!}" class="btn btn-outline-danger ml-2">Clear</a>
                                    </div>
                                </div>
        ...
        <div class="card">
            <div class="card-body" id="report-subscription_list">
            </div>
        </div>
...
@section('js')
<script>
fetch_data('report-subscription',1);
</script>
<script src="{!! asset('assets/backend/js/pages/reportsubscription.js') !!}"></script>
@stop
@endsection
