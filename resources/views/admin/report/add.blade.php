...
<section class="forms">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <form id="frmAddUpdate" name="frmAddUpdate" action="{!! route('admin.report.update') !!}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <input type="text" name="slug" id="slug" value="{!! old('slug') ?? $report->slug !!}" class="form-control">
                                        @error('slug')
                                        <span class="error" role="alert">{!! $message !!}</span>
                                        @enderror
                                    </div> 
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <div class="d-md-flex">
                                            ...
                                            <div class="show-image imageRounded ml-4">
                                                <img src="{!! $report->image !!}" class="" id='image_preview'>
                                             </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 mb-3">
                                        <label class="form-control-label">Image Alt</label>
                                        <input type="text" name="image_alt" id="image_alt" value="{!! old('image_alt') ?? $report->image_alt !!}" class="form-control">
                                        @error('image_alt')
                                        <span class="error" role="alert">{!! $message !!}</span>
                                        @enderror
                                    </div> 
                                    <div class="col-sm-4 mb-3">
                                        ...
                                        <select name="country" id="country" class="form-control">
                                            <option value="Global" {!! ($report->country=='Global') ? 'Selected' : '' !!}>Global</option>
                                            <option value="Regional" {!! ($report->country=='Regional') ? 'Selected' : '' !!}>Regional</option>
                                            <option value="Country" {!! ($report->country=='Country') ? 'Selected' : '' !!}>Country</option>
                                        </select>
                                        @error('country')
                                        <span class="error" role="alert">{!! $message !!}</span>
                                        @enderror
                                    ...
                                    <div class="col-sm-4 mb-3">
                                        ...
                                        <select name="s_c" id="s_c" class="form-control">
                                            ...
                                            <option value="Syndicate" {!! (($report->s_c=='Syndicate') || ($report->s_c=='syndicate')) ? 'Selected' : '' !!}>Syndicate</option>
                                            <option value="Market Intelligence" {!! (($report->s_c=='Market Intelligence') || ($report->s_c=='MI')) ? 'Selected' : '' !!}>Market Intelligence</option>
                                            <option value="Competitor Intelligence" {!! (($report->s_c=='Competitor Intelligence') || ($report->s_c=='CI')) ? 'Selected' : '' !!}>Competitor Intelligence</option>
                                            <option value="Supplier Intelligence" {!! (($report->s_c=='Supplier Intelligence') || ($report->s_c=='SI')) ? 'Selected' : '' !!}>Supplier Intelligence</option>
                                            <option value="Open Innovation" {!! (($report->s_c=='Open Innovation') || ($report->s_c=='OI')) ? 'Selected' : '' !!}>Open Innovation</option>
                                        </select>
                                        @error('s_c')
                                        <span class="error" role="alert">{!! $message !!}</span>
                                        @enderror
                                    ...
                                    <div class="col-sm-4 mb-3">
                                        ...
                                        <input type="text" name="product_id" id="product_id" readonly value="{!! old('product_id') ?? $report->product_id !!}" class="form-control">
                                        @error('product_id')
                                        <span class="error" role="alert">{!! $message !!}</span>
                                        @enderror
                                    </div>
                                    <div class="col-sm-4 mb-3">
                                        ...
                                        <input type="text" name="report_type" id="report_type" readonly value="{!! old('report_type') ?? $report->report_type !!}" class="form-control">
                                        @error('report_type')
                                        <span class="error" role="alert">{!! $message !!}</span>
                                        @enderror
                                    </div>  
                                    <div class="col-sm-4 mb-3">
                                        ...
                                        <input type="text" name="download" id="download" value="{!! old('download') ?? $report->download !!}" class="form-control">
                                        @error('download')
                                        <span class="error" role="alert">{!! $message !!}</span>
                                        @enderror
                                    </div>                                       
                                    <div class="col-sm-4 mb-3">
                                        ...
                                        <input type="text" name="pages" id="pages" value="{!! old('pages') ?? $report->pages !!}" class="form-control">
                                        @error('pages')
                                        <span class="error" role="alert">{!! $message !!}</span>
                                        @enderror
                                    </div>
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <input type="text" name="meta_title" id="meta_title" value="{!! old('meta_title') ?? $report->meta_title !!}" class="form-control">
                                        @error('meta_title')
                                        <span class="error" role="alert">{!! $message !!}</span>
                                        @enderror
                                    </div> 
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <input type="text" name="meta_description" id="meta_description" value="{!! old('meta_description') ?? $report->meta_description !!}" class="form-control">
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <select name="sector_id" id="sector_id" class="form-control">
                                            ...
                                            @foreach ($sectors as $sector)
                                                <option value="{{$sector->id}}" @if($report->sector_id == $sector->id)selected @endif>{{$sector->title}}</option>
                                            @endforeach
                                        </select>
                                        @error('sector_id')
                                        <span class="error" role="alert">{!! $message !!}</span>
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <input type="text" name="free_sample_report_link" id="free_sample_report_link" value="{!! old('free_sample_report_link') ?? $report->free_sample_report_link !!}" class="form-control">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        ...
                                        <textarea name="description" id="description" class="form-control tinymce-editor">{!! old('description') ?? $report->description !!}</textarea>
                                        @error('description')
                                        <span class="error" role="alert">{!! $message !!}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        ...
                                        <textarea name="toc" id="toc" class="form-control tinymce-editor">
                                        @if(!$report->report_tableofcontent->isEmpty())    
                                        {!! $report->report_tableofcontent[0]->toc !!}
                                        @endif
                                        </textarea>
                                        @error('toc')
                                        <span class="error" role="alert">{!! $message !!}</span>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        ...
                                        <textarea name="whats_included" id="whats_included" class="form-control tinymce-editor">{!! old('whats_included') ?? $report->whats_included !!}</textarea>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        ...
                                        <textarea name="methodologies" id="methodologies" class="form-control tinymce-editor">{!! old('methodologies') ?? $report->methodologies !!}</textarea>
                                        @error('methodologies')
                                        <span class="error" role="alert">{!! $message !!}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        ...
                                        <textarea name="analyst_support" id="analyst_support" class="form-control tinymce-editor">{!! old('analyst_support') ?? $report->analyst_support !!}</textarea>
                                ...
                                @if(($report->report_type=='SD') || ($report->report_type=='Upcoming'))
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            ...
                                            <textarea name="market_insights" id="market_insights" class="form-control tinymce-editor">{!! old('market_insights') ?? $report->market_insights !!}</textarea>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        ...
                                        <textarea name="segmental_analysis" id="segmental_analysis" class="form-control tinymce-editor">{!! old('segmental_analysis') ?? $report->segmental_analysis !!}</textarea>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        ...
                                        <textarea name="regional_insights" id="regional_insights" class="form-control tinymce-editor">{!! old('regional_insights') ?? $report->regional_insights !!}</textarea>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        ...
                                        <textarea name="market_dynamics" id="market_dynamics" class="form-control tinymce-editor">{!! old('market_dynamics') ?? $report->market_dynamics !!}</textarea>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        ...
                                        <textarea name="competitive_landscape" id="competitive_landscape" class="form-control tinymce-editor">{!! old('competitive_landscape') ?? $report->competitive_landscape !!}</textarea>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        ...
                                        <textarea name="key_market_trends" id="key_market_trends" class="form-control tinymce-editor">{!! old('key_market_trends') ?? $report->key_market_trends !!}</textarea>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        ...
                                        <textarea name="skyQuest_analysis" id="skyQuest_analysis" class="form-control tinymce-editor">{!! old('skyQuest_analysis') ?? $report->skyQuest_analysis !!}</textarea>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        ...
                                        <textarea name="schema" id="schema" class="form-control">{!! old('schema') ?? $report->schema !!}</textarea>                                        
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12 mb-3 ">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="radio-wrap">
                                            <div class="radiobtn">
                                                <input type="radio" id="is_active_yes" class="form-control checkboxinput" name="is_active" value="1" {!! $report->is_active == '1' ? 'checked' : '' !!} checked>Active
                                                <h1></h1>
                                            </div>
                                            <div class="radiobtn">
                                                <input type="radio" id="is_active_no" class="form-control checkboxinput" name="is_active" value="0" {!! $report->is_active == '0' ? 'checked' : '' !!} >Inactive
                                                <h1></h1>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    $(document).ready(function () {
        var sectorId = {!! $report->sector_id !!};
        var industryGroupId = {!! $report->industry_group_id !!};
        var industryId = {!! $report->industry_id !!};        
        var subIndustryId = {!! $report->sub_industry_id !!}; 
