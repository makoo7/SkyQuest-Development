...
<section class="forms">
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    @if(auth('admin')->user()->can('404-inquiry-export'))
                    <div class="col-lg-12 addlink">
                        <a href="{!! route('admin.404-inquiry.export') !!}"  class="btn btn-primary mb-4 admin-top">Export Data</a>
                    </div>
                    @endif
                    <div class="col-lg-12">
                            ...
                            <div class="filter-row d-flex align-items-center">
                                <div class="mb-3">
                                    <div class="form-inline">
                                        ...
                                        <a id="btn_clear" href="{!! route('admin.404-inquiry.index') !!}" class="btn btn-outline-danger ml-2">Clear</a>
                                    </div>
                                </div>
        ...
        <div class="card">
            <div class="card-body" id="404-inquiry_list">
            </div>
        </div>
...
@section('js')
<script>
fetch_data('404-inquiry',1);
</script>
<script src="{!! asset('assets/backend/js/pages/pagenotfound.js') !!}"></script>
@stop
@endsection
