    ...
    <tr>
        <td align="center" style="background:#fff; padding:25px 30px; border-radius:10px; -webkit-border-radius:10px; -o-border-radius:10px; -moz-border-radius:10px; -ms-border-radius:10px;">
            <table width="100%" style="margin:0;">
                <tr>
                    <td align="left" style="font-size:14px; color:#000; padding:0 0 15px; font-family:Arial, Helvetica, sans-serif;">Hi {!! (isset($user->user_name)) ? $user->user_name : '' !!}, </td>
                </tr>
                <tr>
                    <td align="left" style="font-size:13px; line-height:23px; color:#000; padding:0 0 12px; font-family:Arial, Helvetica, sans-serif;">
                        <p>You are invited in {!! config('app.name') !!}. Please use below credentials to login in the Admin Panel.</p>
                        <p>Email : {!! (isset($user->email)) ? $user->email : '' !!}</p>
                        <p>Password : {!! (isset($user->new_password)) ? $user->new_password : '' !!}</p>
                        <p>Click <a href="{!! route('admin.login') !!}">here</a> to login in admin panel.</p>
                    </td>
                </tr>
                <tr>
