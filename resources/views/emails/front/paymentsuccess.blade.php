    ...
    <tr>
        <td align="center" style="background:#fff; padding:25px 30px; border-radius:10px; -webkit-border-radius:10px; -o-border-radius:10px; -moz-border-radius:10px; -ms-border-radius:10px;">
            <table width="100%" style="margin:0;">
                <tr>
                    <td align="left" style="font-size:14px; color:#000; padding:0 0 15px; font-family:Arial, Helvetica, sans-serif;">Hello {!! (isset($paymentsuccess->name)) ? $paymentsuccess->name : '' !!}, </td>
                </tr>
                <tr>
                    <td align="left" style="font-size:13px; line-height:23px; color:#000; padding:0 0 12px; font-family:Arial, Helvetica, sans-serif;">
                        <p>Thank you so much for purchasing our research report <a href="{!! (isset($paymentsuccess->report->slug)) ? url('report/'.$paymentsuccess->report->slug) : '' !!}">{!! (isset($paymentsuccess->report->name)) ? $paymentsuccess->report->name : '' !!}</a></p>
                        <p>We have received your payment. You will get the report copy in next 36-48 hrs.</p>
