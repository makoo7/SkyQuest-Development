$(document).ready(function () {
    ...
    $("#frmAddUpdate").validate({
        ...
        messages: {
            ...
            feedback: { required: "Please provide a feedback."},
        },
...
$(document).on('click', '#client-feedback_nav a', function (event) {
    event.preventDefault();
    var page = $(this).attr('href').split('page=')[1];
    $("#page").val(page);
    fetch_data('client-feedback',page);
});

function deleteClientImage(id) {
    let eventclose = true;
    $.prompt(' ', {
        ...
        submit: function (e, v, m, f) {
            if (v) {
                ...
                $.ajax({
                    ...
                    url: baseUrl + 'client-feedback/deleteImage',
                    dataType: 'json',
                    data: { 'id': id },
